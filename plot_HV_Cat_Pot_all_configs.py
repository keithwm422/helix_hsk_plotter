...
file_name="hv_data_DMM_all_configs_plot.csv"
...
axs.scatter(temp_df.DAC, temp_df['C,O,O,O'], marker='*', s=20,label='Cathode/Drift O,O,O') #this is a temp by the inflections.
