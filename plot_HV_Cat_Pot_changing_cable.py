...
file_name="HV_calibration_change_cable_percent_change.csv"
...
axs.scatter(temp_df.DAC, temp_df['Cat-AB'], marker='*', s=20,label='Cathode/Drift O,O') #this is a temp by the inflections.
axs.scatter(temp_df.DAC, temp_df['Cat-CD'], marker='o', s=20,label='Cathode/Drift O,S') #this is a temp by the inflections.
axs.scatter(temp_df.DAC, temp_df['Cat-EF'], marker='.', s=20,label='Cathode/Drift S,O') #this is a temp by the inflections.
...
plt.ylabel("Difference switching cable (O-S %)")
